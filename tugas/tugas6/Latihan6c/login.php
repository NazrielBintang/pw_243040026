...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($username === "Nazriel" && $password === "bintang") {
    ...
    <div class="container">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <input id="username" name="username" required="Nazriel" type="text" />
            </div>
            <div class="form-group">
                <label for="password">
                    Password:
                </label>
                <input id="password" name="password" required="Bintang" type="password" />
            </div>
